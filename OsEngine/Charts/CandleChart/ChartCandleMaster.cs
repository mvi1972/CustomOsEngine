...
namespace OsEngine.Charts.CandleChart
{
    ...
    public class ChartCandleMaster
    {
        ...
        /// this variable protects the SaveParamBot method from being saved incorrectly at this time
        /// во время загрузки данных, робот пытается тутже сохранять их,т.к. создаются индикаторы
        /// эта переменная защищает метод SaveParamBot от ошибочного сохранения в это время
        /// </summary>
